    ...
    <div className="relative z-10 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
        <div>
          ...
          <p className="text-gray-400 font-medium">View and manage all new player registration forms submitted via the website.</p>
        </div>
        <button 
                ...
                <tr key={reg.id} className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-6 py-5 opacity-100 sm:opacity-50 group-hover:opacity-100 transition-opacity">
                    <div className="flex items-center justify-end gap-3 whitespace-nowrap">
                      <button 
                        onClick={() => window.open(`/print-registration/${reg.id}`, '_blank')}
