...
import { Users, Search, Plus, Trash2, X, MapPin, Edit3, Image as ImageIcon, UploadCloud, Loader2, Building } from 'lucide-react';
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-black text-white tracking-tighter uppercase mb-2 flex items-center gap-3 drop-shadow-[0_2px_10px_rgba(255,0,0,0.2)]">
            ...
            Coach <span className="text-red-600">& Academy</span>
          </h2>
