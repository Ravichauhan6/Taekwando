  ...
  if (isLoading) {
    return (
      <section className="pt-10 pb-6 bg-[#050505] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="w-24 h-6 bg-red-500/10 border border-red-500/20 animate-pulse mx-auto rounded-full mb-4" />
            <div className="w-48 h-10 bg-white/5 animate-pulse mx-auto rounded-xl" />
            <div className="w-20 h-1 bg-red-600/50 mx-auto mt-6 rounded-full" />
          </div>
          <div className="grid md:grid-cols-2 gap-12">
            {[1, 2].map((i) => (
              <div key={i} className="bg-[#0d0d0d] border border-white/5 rounded-[40px] p-8 md:p-10 animate-pulse">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                  <div className="w-32 h-32 md:w-40 md:h-40 rounded-[32px] bg-white/5 border border-white/10 flex-shrink-0" />
